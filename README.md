...
<p><em>在校学生 | AI 应用探索者</em></p>

[![GitHub followers](https://img.shields.io/github/followers/Awfp1314?label=关注&style=social)](https://github.com/Awfp1314)
[![博客](https://img.shields.io/badge/博客-awfp1314.github.io-blue)](https://awfp1314.github.io)
![访问量](https://visitor-badge.laobi.icu/badge?page_id=Awfp1314.Awfp1314)

### 🚀 关于我

我是一名在校学生，对 AI 应用和实用工具开发充满热情。目前专注于：

- 🤖 学习和探索 AI 应用开发（LLM、RAG、MCP 协议）
- 🎮 开发虚幻引擎相关的实用工具
- 🌐 使用现代框架构建 Web 应用
...
- [Obsidian 阿里云 OSS 同步配置教程](https://awfp1314.github.io/2026/4/obsidian阿里云oss同步/) - 说白了，就是用阿里云的对象存储来同步 Obsidian 笔记，多端访问无压力
- [OpenClaw 部署指南](https://awfp1314.github.io/2026/4/openclaw部署指南/) - 详细记录 OpenClaw 在 Windows 系统上的完整部署过程，包括环境准备、安装配置、模型设置等步骤
- [Obsidian OneDrive 同步配置教程](https://awfp1314.github.io/2026/4/obsidian-onedrive同步/) - 说白了，就是用 OneDrive 的免费 5G 空间来同步 Obsidian 笔记
- [RAG：给大模型外挂一个知识库](https://awfp1314.github.io/2026/3/rag检索增强生成/) - 说白了，RAG 就是给大模型外挂了一套知识库。每次提问时先去知识库里翻翻资料，然后让大模型根据找到的信息回答，这样就不会瞎编了。
...
![访问统计](https://komarev.com/ghpvc/?username=Awfp1314&color=blueviolet)
